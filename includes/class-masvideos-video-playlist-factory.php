...
class MasVideos_Video_Playlist_Factory {
     ...
     * @return MasVideos_Video_Playlist|bool Video Playlist object or null if the tv show cannot be loaded.
     */
    ...
    /**
     * Gets a tv show classname and allows filtering. Returns MasVideos_Video_Playlist if the class does not exist.
     *
     * @since  1.0.0
