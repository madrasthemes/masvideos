 ...
 * Attribute class.
 */
class MasVideos_Attribute implements ArrayAccess {
    ...
    public function get_taxonomy_object() {
        ...
        return $this->is_taxonomy() ? $masvideos_attributes[ $this->get_name() ] : null;
    }
    ...
    public function get_data() {
        return array_merge(
            $this->data, array(
                ...
                'value'        => $this->is_taxonomy() ? '' : masvideos_implode_text_attributes( $this->get_options() ),
            )
        );
    }
    ...
    */
     ...
     * Set if visible.
     *
     * @param bool $value If is visible on additional info tab.
     */
    public function set_visible( $value ) {
        $this->data['visible'] = masvideos_string_to_bool( $value );
    }
    ...
    */
    ...
    public function offsetGet( $offset ) {
        switch ( $offset ) {
            ...
            case 'value':
                return $this->is_taxonomy() ? '' : masvideos_implode_text_attributes( $this->get_options() );
            default:
