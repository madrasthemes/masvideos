...
function masvideos_get_permalink_structure() {
    ...
    $permalinks       = wp_parse_args(
        array_filter( $saved_permalinks ), array(
            ...
            'video_playlist_base'          => _x( 'video_playlist', 'slug', 'masvideos' ),
            ...
            'movie_playlist_base'          => _x( 'movie_playlist', 'slug', 'masvideos' ),
            ...
            'tv_show_playlist_base'        => _x( 'tv_show_playlist', 'slug', 'masvideos' ),
