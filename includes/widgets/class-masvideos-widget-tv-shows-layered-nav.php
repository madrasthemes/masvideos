 ...
 */
class MasVideos_Widget_TV_Shows_Layered_Nav extends MasVideos_Widget {
    ...
    public function __construct() {
        ...
        $this->widget_name        = esc_html__( 'Filter TV Shows by Attribute', 'masvideos' );
        parent::__construct();
    }
    ...
    protected function layered_nav_dropdown( $terms, $taxonomy, $query_type ) {
        ...
        if ( $taxonomy !== $this->get_current_taxonomy() ) {
            ...
            $taxonomy_label       = masvideos_tv_show_attribute_label( $taxonomy );
            ...
            echo '<form method="get" action="' . esc_url( $form_action ) . '" class="masvideos-widget-tv-shows-layered-nav-dropdown">';
            echo '<select class="masvideos-widget-tv-shows-layered-nav-dropdown dropdown_layered_nav_' . esc_attr( $taxonomy_filter_name ) . '"' . ( $multiple ? 'multiple="multiple"' : '' ) . '>';
            ...
            if ( $multiple ) {
                echo '<button class="masvideos-widget-tv-shows-layered-nav-dropdown__submit" type="submit" value="' . esc_attr__( 'Apply', 'masvideos' ) . '">' . esc_html__( 'Apply', 'masvideos' ) . '</button>';
            }
