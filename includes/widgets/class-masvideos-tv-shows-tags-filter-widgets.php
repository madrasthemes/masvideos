 ...
 */
class MasVideos_TV_Shows_Tags_Filter_Widget extends MasVideos_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        $terms = get_terms( $taxonomy, apply_filters( 'masvideos_tv_shows_tags_filter_widget_terms_args', $get_terms_args ) );
