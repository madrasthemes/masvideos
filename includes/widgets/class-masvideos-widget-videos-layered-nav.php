 ...
 */
class MasVideos_Widget_Videos_Layered_Nav extends MasVideos_Widget {

    /**
     * Constructor.
     */
    public function __construct() {
        $this->widget_cssclass    = 'masvideos widget_layered_nav masvideos-widget-videos-layered-nav';
        $this->widget_description = esc_html__( 'Display a list of attributes to filter videos in your site.', 'masvideos' );
        $this->widget_id          = 'masvideos_widget_videos_layered_nav';
        $this->widget_name        = esc_html__( 'MAS Videos Filter Videos by Attribute', 'masvideos' );
        parent::__construct();
    }
    ...
    protected function layered_nav_dropdown( $terms, $taxonomy, $query_type ) {
        ...
        if ( $taxonomy !== $this->get_current_taxonomy() ) {
            ...
            $taxonomy_label       = masvideos_video_attribute_label( $taxonomy );
            ...
            echo '<form method="get" action="' . esc_url( $form_action ) . '" class="masvideos-widget-videos-layered-nav-dropdown">';
            echo '<select class="masvideos-widget-videos-layered-nav-dropdown dropdown_layered_nav_' . esc_attr( $taxonomy_filter_name ) . '"' . ( $multiple ? 'multiple="multiple"' : '' ) . '>';
            ...
            if ( $multiple ) {
                echo '<button class="masvideos-widget-videos-layered-nav-dropdown__submit" type="submit" value="' . esc_attr__( 'Apply', 'masvideos' ) . '">' . esc_html__( 'Apply', 'masvideos' ) . '</button>';
            }
    ...
    /**
     * Count videos within certain terms, taking the main WP query into consideration.
     *
     * This query allows counts to be generated based on the viewed videos, not all videos.
     *
