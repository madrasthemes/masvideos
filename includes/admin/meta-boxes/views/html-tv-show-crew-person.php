            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        <select data-placeholder="<?php esc_attr_e( 'Select term', 'masvideos' ); ?>" class="person_categories masvideos-enhanced-select" name="cast_person_categories[<?php echo esc_attr( $i ); ?>]">
                            <?php
