            ...
            <tbody>
                <tr>
                    <td class="season_name">
                        ...
                        <input type="text" class="season_name" name="season_names[<?php echo esc_attr( $i ); ?>]" value="<?php echo esc_attr( $season['name'] ); ?>" />
                ...
                <tr>
                    <td>
                        <div id="season_image_id_<?php echo esc_attr( $i ); ?>" class="form-field media-attachment-image media-option">
                            <label><?php echo esc_html__( 'Season image', 'masvideos' ); ?></label>

                            <img class="upload_image_preview" src="<?php echo $season['image_id'] ? esc_url( wp_get_attachment_thumb_url( $season['image_id'] ) ) : esc_url( masvideos_placeholder_img_src() ); ?>" data-placeholder-src="<?php echo esc_url( masvideos_placeholder_img_src() ); ?>" />
