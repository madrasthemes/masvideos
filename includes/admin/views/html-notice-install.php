...
<div id="message" class="updated masvideos-message masvideos-connect">
	...
	<p class="submit"><a href="<?php echo esc_url( admin_url( 'admin.php?page=masvideos-setup' ) ); ?>" class="button-primary"><?php _e( 'Create Pages', 'masvideos' ); ?></a> <a class="button-secondary skip" href="<?php echo esc_url( wp_nonce_url( add_query_arg( 'masvideos-hide-notice', 'install' ), 'masvideos_hide_notices_nonce', '_masvideos_notice_nonce' ) ); ?>"><?php _e( 'Skip', 'masvideos' ); ?></a></p>
</div>
