 ...
 * Your own data store doesn't need to use MasVideos_Data_Store_WP -- you can write
...
/**
 * MasVideos_Data_Store_WP class.
 */
class MasVideos_Data_Store_WP {
     ...
     *
     * @since  1.0.0
     * @param  MasVideos_Data $object MasVideos_Data object.
     * @return array
     */
    public function read_meta( &$object ) {
        ...
        return apply_filters( "masvideos_data_store_wp_{$this->meta_type}_read_meta", $meta_data, $object, $this );
    }
     ...
     *
     * @param  MasVideos_Data $object       The WP_Data object (MasVideos_Movie for movies, etc).
    ...
    /**
     * Get valid WP_Query args from a MasVideos_Object_Query's query variables.
     *
     * @since 1.0.0
     * @param array $query_vars query vars from a MasVideos_Object_Query.
     * @return array
     */
    protected function get_wp_query_args( $query_vars ) {
        ...
        return apply_filters( 'masvideos_get_wp_query_args', $wp_query_args, $query_vars );
    }
    ...
    public function parse_date_for_wp_query( $query_var, $key, $wp_query_args = array() ) {
        ...
        try {
            ...
            if ( is_a( $query_var, 'MasVideos_DateTime' ) ) {
                ...
                $dates[]   = masvideos_string_to_datetime( $query_var );
                $precision = 'day';
            }
        } catch ( Exception $e ) {
    ...
    protected function get_valid_search_terms( $terms ) {
        ...
        foreach ( $terms as $term ) {
            ...
            if ( in_array( masvideos_strtolower( $term ), $stopwords, true ) ) {
                continue;
            }
    ...
    protected function get_search_stopwords() {
        ...
        $stopwords = array_map(
            'masvideos_strtolower', array_map(
                'trim', explode(
                    ',', _x(
