...
jQuery( function( $ ) {
    ...
    // Type box.
    $( '.type_box' ).appendTo( '#masvideos-video-data .hndle span' );

    $( function() {
        // Prevent inputs in meta box headings opening/closing contents.
        $( '#masvideos-video-data' ).find( '.hndle' ).unbind( 'click.postboxes' );

        $( '#masvideos-video-data' ).on( 'click', '.hndle', function( event ) {
            ...
            $( '#masvideos-video-data' ).toggleClass( 'closed' );
        });
    });
