...
registerBlockType( 'vodi/section-videos-carousel-flex-header', {
    ...
    edit: ( ( props ) => {
        ...
        const { section_title, section_nav_links, section_background, section_style, footer_action_text, footer_action_link, shortcode_atts, carousel_args, design_options } = attributes;
