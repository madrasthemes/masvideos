...
registerBlockType( 'vodi/section-coming-soon-videos', {
    ...
    edit: ( ( props ) => {
        ...
        const { coming_soon_videos_title, footer_action_text, footer_action_link, shortcode_atts, design_options } = attributes;

        const onChangeSectionTitle = newSectionTitle => {
            setAttributes( { coming_soon_videos_title: newSectionTitle } );
        };
