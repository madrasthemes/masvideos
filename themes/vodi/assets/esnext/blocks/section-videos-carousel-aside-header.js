...
registerBlockType( 'vodi/section-videos-carousel-aside-header', {
    ...
    edit: ( ( props ) => {
        ...
        const { section_title, section_subtitle, action_text, action_link, header_posisition, section_background, section_style, shortcode_atts, carousel_args, design_options } = attributes;
            ...
            <Fragment>
                <InspectorControls>
                    ...
                    <SelectControl
                        ...
                        options={ [
                            { label: __('Left', 'vodi'), value: 'header-left' },
