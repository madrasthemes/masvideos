...
registerBlockType( 'vodi/movie-section-aside-header', {
    title: __('Movies Section Aside Header Block', 'vodi'),
    ...
    edit: ( ( props ) => {
        ...
        const { section_title, section_subtitle, section_background, section_style, action_text, action_link, shortcode_atts_1, shortcode_atts_2, design_options } = attributes;
        ...
        return (
            <Fragment>
                <InspectorControls>
                    ...
                    />
                    <PanelBody
                        title={__('Movies Attributes 1', 'vodi')}
                        initialOpen={ true }
                    >
                        <ShortcodeAtts
                            postType = 'movie'
                     ...
                     <PanelBody
                        title={__('Movies Attributes 2', 'vodi')}
                        initialOpen={ true }
                    >
                        <ShortcodeAtts
                            postType = 'movie'
