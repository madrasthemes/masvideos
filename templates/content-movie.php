...
<div <?php masvideos_movie_class(); ?>>
     ...
     */
    do_action( 'masvideos_before_movies_loop_item' );

    /**
     * Hook: masvideos_before_movies_loop_item_title.
     *
     * @hooked masvideos_show_movie_loop_sale_flash - 10
     * @hooked masvideos_template_loop_movie_thumbnail - 10
     */
    do_action( 'masvideos_before_movies_loop_item_title' );

    /**
     * Hook: masvideos_movies_loop_item_title.
     *
     * @hooked masvideos_template_loop_movie_title - 10
     */
    do_action( 'masvideos_movies_loop_item_title' );

    /**
     * Hook: masvideos_after_movies_loop_item_title.
     *
     * @hooked masvideos_template_loop_rating - 5
     * @hooked masvideos_template_loop_price - 10
     */
    do_action( 'masvideos_after_movies_loop_item_title' );

    /**
     * Hook: masvideos_after_movies_loop_item.
     *
     * @hooked masvideos_template_loop_movie_link_close - 5
     * @hooked masvideos_template_loop_add_to_cart - 10
     */
    do_action( 'masvideos_after_movies_loop_item' );
    ?>
</div>
